...
export type ExercisesRequestBody = {
  daily_exercises: number[];
  target: number;
};

export const calculateExercise = (exerciseHours: Array<number>, target: number): exerciseSummary => {
...
//   parameterArray.reduce((acc, val, _ind) => {
